...
export const ThemeSwitch = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="theme-switch-button flex h-9 w-9 items-center justify-center rounded-md border border-border bg-card text-foreground transition-colors hover:opacity-90 focus:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
